                    ...
                    $('.form-check-input').change(function(){
                        ...
                        if($(this).is(':checked')){
                            ...
                            // Update the href attribute of the anchor tag
                             $('#editLink').attr('href', '/admin/persons/' + value + '/edit/');
                             $('#viewLink').attr('href', '/admin/persons/' + value + '/show/');
                             $('#deleteLink').attr('href', '/admin/persons/' + value + '/edit/');
                             $('#formDelete').attr('action', '/admin/persons/' + value );
